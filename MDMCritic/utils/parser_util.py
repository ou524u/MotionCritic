...
def add_generate_options(parser):
    ...
    group.add_argument("--model_step", default=50000, type=int,
                       help="model step")
...
def add_tuning_options(parser):
    ...
    group.add_argument("--render_video", action='store_true',
                       help="render video during training")
    group.add_argument("--sample_when_eval", action='store_true',
                       help="sample when eval")
    group.add_argument("--render_batch_size", default=1, type=int,
                       help="eval render batch")
    group.add_argument("--random_critic_loss", action='store_true',
                       help="add random loss to critic_loss")
    group.add_argument("--no_critic_loss", action='store_true',
                       help="no critic_loss")
    group.add_argument("--use_kl_loss", action='store_true',
                       help="use kl loss")
    group.add_argument("--relu_loss", action='store_true',
                       help="use relu loss")
    group.add_argument("--render_gt", action='store_true',
                       help="add random loss to critic_loss")
    group.add_argument("--critic_scale", default=0.1, type=float,
