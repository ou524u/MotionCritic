...
def main():
    ...
    print("Training...")
    TuneLoop(args, train_platform, model, diffusion, data, critic_model).my_eval_critic_condbatch()
    # TuneLoop(args, train_platform, model, diffusion, data, critic_model).my_eval_gtfullbatch()
    # TuneLoop(args, train_platform, model, diffusion, data, critic_model).my_savegt_uestc()
